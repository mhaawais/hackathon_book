...
Documentation for the retrieval validation system that tests query retrieval accuracy against the Qdrant `docusaurus_content` collection.
...
The validation system follows a read-only approach:
1. Query → Cohere embedding generation
2. Vector search against Qdrant collection
3. URL-based filtering to prioritize book content
4. Metadata validation
5. Result scoring and aggregation
6. Report generation